...
//        public int AddItem(Person item, CancellationToken token)
//        {
//            data.Add(item);
...
//        public Task AddItemAsync(Person item, CancellationToken token)
//        {
//            throw new NotImplementedException();
//        }

//        public void DeleteItem(int id, CancellationToken token)
//        {
//            data.Remove(data.Where(i => i.Id == id).FirstOrDefault());
//        }

//        public Task DeleteItemAsync(Guid id, CancellationToken token)
//        {
//            throw new NotImplementedException();
//        }

//        public IEnumerable<Person> GetAll(CancellationToken token) => data;

//        public Task<IEnumerable<Person>> GetAllAsync(CancellationToken token)
//        {
//            throw new NotImplementedException();
//        }

//        public int UpdateItem(Person item, CancellationToken token)
//        {
